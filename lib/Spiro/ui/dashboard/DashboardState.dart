...
class _DashboardPageContentState extends State<DashboardPageContent>
  ...
  Future<void> _loadDashboardData() async {
    try {
      ...
      // Create a temporary ViewModel instance for API calls
      final viewModel = ViewDashboard(context, _DashboardConnection());

      // Load all dashboard data concurrently
      final results = await Future.wait([
        viewModel.getDashboardData(),
        viewModel.getOnShiftAgents(),
        viewModel.getActiveAlerts(),
      ]);
