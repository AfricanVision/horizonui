...
class ParentViewModel extends ChangeNotifier{
  ...
  ParentViewModel(this.context){
    ...
    dataManager = AppDataManager(InternalMemory(),  Comms(InternalMemory()), FileStorage());
  }
    ...
    if (loadingEntry == null) {
      ...
      loadingEntry = OverlayEntry(builder: (context) {
        return Scaffold(
          ...
          body: SafeArea(
            child: Center(child: Padding(padding: const EdgeInsets.symmetric(horizontal: 24,),
              child: Row(
                  ...
                  Flexible(child: Column(mainAxisSize: MainAxisSize.min,
                    children: [SpinKitWaveSpinner(
                      ...
                      Padding(padding: const EdgeInsets.only(top: 40, bottom: 40),
                        child: textWithColor(
                            loadingText,  24, TextType.Regular,colorPrimary),
                      )
                    ],),),
                  Padding(padding: const EdgeInsets.only(left: 24),
                    child: RotatedBox(quarterTurns: -1,
                      child: Row(
                        ...
                        children: [
                          Image.asset(logoPng, width: 55, height: 55,),
                          Flexible(child: textWithColor("Spiro".toUpperCase(), 25, TextType.Regular, colorPrimary))
                        ],),),)
                ],),),),
          ),);
      });
  ...
  showApplicationNotification(NotificationType type, String title, String description, bool enableDrag, bool barrierDismiss, popParam,VoidCallback? closeAction) async{
                ...
                children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          child:  textWithColor(type.name.toUpperCase(), 28, TextType.SemiBold, actionColor),)
                        ],
                      ),

                      backButtonWithActionAndIcon(CupertinoIcons.clear,context,  () {
                        if(popParam != null){
                  ...
                  Padding(padding: const EdgeInsets.symmetric(vertical: 16),
                    child: Column(  mainAxisSize: MainAxisSize.max,
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        textWithColor(title, 18, TextType.SemiBold, colorPrimaryDark),
                        Padding(padding: const EdgeInsets.only(top: 16),
                          child: textWithColor(description, 12, TextType.Regular, colorPrimaryDark2),)
                      ],),)
                ],),),)
        );
      },
  ...
  showApplicationNotificationWithAction(NotificationType type, String title, String description, String action,bool draggable, bool barrierDismiss,VoidCallback? positiveAction,VoidCallback? cancelAction) async{
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      backButtonWithActionAndIcon(CupertinoIcons.clear,context, cancelAction)
                  ...
                  Padding(padding: const EdgeInsets.symmetric(vertical: 16),
                    child: Column(  mainAxisSize: MainAxisSize.max,
                      ...
                      children: [
                        textWithColor(title, 18, TextType.SemiBold, colorPrimaryDark),
                        Padding(padding: const EdgeInsets.only(top: 16),
                          child: textWithColor(description, 12, TextType.Regular, colorPrimaryDark),)
                      ],),),
              ...
              children: [
                ...
                Padding(padding: const EdgeInsets.only(top: 40, bottom: 40, left: 40, right: 40),
                  child: Column(mainAxisSize: MainAxisSize.min,
                    ...
                    children: [
                      textWithColor(
                          "Oops, No Internet Connections", 30, TextType.Bold, colorPrimaryLight),
                      Padding(padding: const EdgeInsets.only(top: 10),
                        child:   textWithColor(
                            "Kindly make sure that your wifi or cellular data are turned on and try again.", 14, TextType.Light,colorPrimaryLight),),
  ...
  handleError(Object? error, Function() actions, Function() closeAction,String buttonName) {
    ...
    if (error is DioException) {
      ...
      if (error.type == DioExceptionType.connectionTimeout) {
        ...
        }else if(error.code == 1000.0001 || error.code == 1200.0012 || error.code == 900.009 || error.code == 5000.0005) {
              ...
              return ConstrainedBox(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(padding: const EdgeInsets.only(left: 16, right: 16, top: 32, bottom: 16),
                      child:  text(error.severity.toUpperCase(), 40, TextType.Bold),),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(padding: const EdgeInsets.only(top: 8, bottom: 8, left: 16, right: 16),
                              child: textWithColor("Code: ${error.code.toString()}", 10, TextType.Regular, colorAccent),),
                            Padding(padding: const EdgeInsets.only(top: 8, bottom: 8, left: 16, right: 16),
                              child: textWithColor("Mention the code above when contacting our help desk to make it easier to assist you.", 7, TextType.Regular, colorGrey2),),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Padding(padding: const EdgeInsets.only(bottom: 16, top: 32, left: 16, right: 16),
                              child: textWithColor("What happened.", 9, TextType.Bold, colorPrimaryDark),),

                            Padding(padding: const EdgeInsets.only(bottom: 16, left: 16, right: 16),
                                child: text(error.message, 12, TextType.Regular)),

                            Padding(padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 16),
                              child: textWithColor("What to do.", 9, TextType.Bold, colorPrimaryDark,),),

                            Padding(padding: const EdgeInsets.only(bottom: 16, left: 16, right: 16),
                              child: text(error.helper, 12, TextType.Regular),)
                          ],
                        ),),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                              ...
                              child: RotatedBox(
                                ...
                                child:  ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      elevation: 5, backgroundColor: colorTinted,
                            ...
                            Padding(padding: const EdgeInsets.only(bottom: 8),
                              child: RotatedBox(
                                ...
                                child:  ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      elevation: 5, backgroundColor: colorPrimary,
                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5),),
                                      padding: const EdgeInsets.only(left: 16, top: 18, bottom: 18, right: 16),
                                    ),
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  textWithColor("IMAGE SELECTION", 24, TextType.Bold, colorMilkWhite),
                  Padding(padding: const EdgeInsets.only(top: 4),
                    child: textWithColor("Below are the options available to you to select an image. Click on an option to proceed.", 10, TextType.Regular, colorGrey2),),
                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){ option = 1;  Navigator.pop(context);},
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            Padding(padding: const EdgeInsets.only(top: 16),
                              child: Column(
                                ...
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  textWithColor("CAPTURE", 20, TextType.SemiBold, colorPrimary),
                                  textWithColor("IMAGE", 20, TextType.SemiBold, colorPrimary),
                                  textWithColor("Click to take an image using your device camera.", 8, TextType.Regular, colorPrimary),
                                ],),)
                          ],
                        )),),),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: (){ option = 2;  Navigator.pop(context);},
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            Padding(padding: const EdgeInsets.only(top: 16),
                              child: Column(
                                ...
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  textWithColor("SELECT", 20, TextType.SemiBold, colorTinted),
                                  textWithColor("IMAGE", 20, TextType.SemiBold, colorTinted),
                                  textWithColor("Click to select an image from your device.", 8, TextType.Regular, colorTinted),
                                ],),)
                          ],
                        )),)
                ],),
              ...
              SizedBox(
                width: double.infinity,
                child: roundedCornerButton('CANCEL', (){Navigator.pop(context);}),)
            ],),);
      },
