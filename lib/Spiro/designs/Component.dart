...
expansionListTitle(Widget? icon, String title, String description, bool flip,){
  return Column(
    ...
    children: [
      ...
      Padding(
        padding:  EdgeInsets.only(top: 4, bottom: 4, left: flip ? 14 : 0, right: !flip ? 24: 0,),
        child: Divider(
          color: colorPrimary,
        ),
      )
  ...
  if(state) {
    return Row(
      ...
      children: [
        ...
        textWithColorAndLimit(title, 14, TextType.Bold,1,colorMilkWhite, TextAlign.center),
...
navigatorFooter(String title, String subtitle, Color color,Widget leadingWidget, bool state){
  if(state) {
    return Container(
      decoration: BoxDecoration(
          color: colorPrimaryDark,
          ...
          Expanded(child: Column(
            ...
            children: [
              ...
              Padding(padding: const EdgeInsets.only(top: 2),
                child: textWithColor(
                    subtitle, 8, TextType.Regular, colorMilkWhite),)
            ],
          ),),
...
navigatorListHeader(String title, String subtitle, Color color,Widget leadingWidget, Widget trailingWidget){
  return Container(
    decoration: BoxDecoration(
        color: colorPrimaryDark,
        borderRadius: BorderRadius.circular(8)
          ...
          children: [
            ...
            Expanded(child: Column(
              ...
              children: [
                textWithColor(title, 14, TextType.Bold, colorMilkWhite),
                Padding(padding: const EdgeInsets.only(top: 2),
                  child: textWithColor(subtitle, 8, TextType.Regular, colorMilkWhite),)
              ],
            ),),
...
navigatorListTile(String title, String description, IconData? leadingIcon, IconData? trailingIcon,GestureTapCallback? clickAction ){
...
navigatorExpansionListTile(BuildContext context, IconData? leadingIcon, IconData? trailingIcon,String title, String description, List<Widget> children){
...
expansionPanelButton(String label,String details, Color color, VoidCallback? onPressed){
  return InkWell(
    onTap: onPressed,
    child: SizedBox(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            child:  textWithColor(details, 10, TextType.SemiBold, colorMilkWhite),),
...
raisedButton(String label, VoidCallback? onPressed){
  ...
  return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: colorPrimary,
...
inputFieldPassword(String label, FormFieldValidator<String> validator, bool enabled, TextInputType textInputType, String helpers, bool obscured,GestureTapCallback? tapAction,
    TextEditingController controller,
    List<TextInputFormatter> inputFormatters, FocusNode textFieldFocusNode){
    ...
    decoration: InputDecoration(
      ...
      suffixIcon: Padding(
        ...
        child:  GestureDetector(
          onTap: tapAction,
          child:  Padding(padding:  const EdgeInsets.only(left: 8, right: 16,),
            child: obscured ?  Icon(CupertinoIcons.eye_slash_fill,
              size: 20,
              color: colorPrimary,
      ...
      labelText: label,
      helperText: helpers,
      helperStyle: TextStyle(color: colorGrey2, fontSize: 12, fontFamily: getTextType(TextType.Regular)),
      hintStyle: TextStyle(color: colorGrey2, fontSize: 10, fontFamily: getTextType(TextType.Regular)),
      errorStyle: TextStyle(color: colorNegative, fontSize: 12,fontFamily: getTextType(TextType.Regular)),
      labelStyle: TextStyle(color: colorPrimaryDark, fontSize: 16, fontFamily: getTextType(TextType.Regular)),
...
inputFieldUserCode(String label, FormFieldValidator<String> validator, bool enabled, TextInputType textInputType, String helpers, IconData prefixIcon, TextEditingController controller, List<TextInputFormatter> inputFormatters) {
  return TextFormField(
    enabled: enabled,
    validator: validator,
    controller: controller,
    ...
    decoration: InputDecoration(
      prefixIcon: Padding(padding: EdgeInsets.only(left: 16, right: 16,),
        child: Icon(
          prefixIcon,
          size: 20,
          color: colorPrimary,
...
inputPhoneNumber(String label, String helpers, bool enabled, PhoneController controller,FormFieldValidator<PhoneNumber> validator,ValueChanged<PhoneNumber>? onChange,){
...
inputField(String label, FormFieldValidator<String> validator, bool enabled, TextInputType textInputType, String helpers, IconData prefixIcon, TextEditingController controller, List<TextInputFormatter> inputFormatters) {
  return TextFormField(
    enabled: enabled,
    validator: validator,
    controller: controller,
...
selectFieldCustom(String label, FormFieldValidator<String> validator, bool enabled, TextInputType textInputType, String helpers, GestureTapCallback? onTap, TextEditingController controller, List<TextInputFormatter> inputFormatters) {
  return TextFormField(
    ...
    textCapitalization: TextCapitalization.sentences,
    decoration: InputDecoration(
      suffixIcon:  Padding(padding: EdgeInsets.only(left: 16, right: 16,),
        child: Icon(Icons.arrow_drop_down_rounded, color: colorPrimary, size: 25,),),
      prefixIcon: Padding(padding: EdgeInsets.only(left: 16, right: 16,),
        child: Icon(
...
userImageRounded(Widget widget, Color background,VoidCallback? callback ){
  ...
  return ElevatedButton(onPressed: callback,
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: background,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10),),
        padding: const EdgeInsets.all(9),
      ),
      child: widget);
...
inputTextArea(String label, FormFieldValidator<String> validator, bool enabled,  String helpers, TextEditingController controller, int minLines, int maxLines,List<TextInputFormatter> inputFormatters) {
  return TextFormField(
    enabled: enabled,
    validator: validator,
    controller: controller,
...
datePicker(String label,  String helpers, FormFieldValidator<DateTime> validator, TextEditingController controller, DateTime firstDate, DateTime lastDate, DateTime? initialDate){

  return DateTimeField(
    format: DateFormat('EEE, d MMM yyyy'),
    validator: validator,
    controller: controller,
    resetIcon:  Icon(CupertinoIcons.clear_thick,
      size: 20,
      color: colorReddish,),
    style:  TextStyle(
    color: colorPrimaryDark,
...
dateTimePicker(String label,  String helpers, FormFieldValidator<DateTime> validator, TextEditingController controller, DateTime firstDate, DateTime lastDate, ){
  return DateTimeField(
                ...
                return Theme(
                  data: Theme.of(context).copyWith(
                    ...
                    timePickerTheme: TimePickerThemeData(
                      ...
                      states.contains(MaterialState.selected) ? colorMilkWhite : colorPrimaryAccent),
                      hourMinuteTextColor: MaterialStateColor.resolveWith(
                              (states) => states.contains(MaterialState.selected) ? colorPrimaryDark : colorPrimary),
...
buttonWithIconAndLabelVertical(String icon, String label, Color primary, Color background, double radius, double textSize, double iconSize,VoidCallback? onPressed){
  return ElevatedButton(
      onPressed: onPressed,
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: background,
...
buttonWithIconAndLabel(IconData icon, String label, Color primary, Color background, double radius, VoidCallback? onPressed){
  return ElevatedButton(
      onPressed: onPressed,
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: background,
...
roundedIconButton(Widget icon, Color color,VoidCallback? onPressed){
  return ElevatedButton(
      onPressed: onPressed,
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: color,
...
rectangularCurvedButton(IconData icon, Color background, Color iconColor, double size,
...
squareButton(String icon, Color backGround, Color iconColor,VoidCallback? onPressed){
  return ElevatedButton(
      onPressed: onPressed,
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: backGround,
...
roundedStyleIconButton(IconData icon, VoidCallback? onPressed){
  return ElevatedButton(
      onPressed:onPressed,
      style: ElevatedButton.styleFrom(
        elevation: 3, backgroundColor: colorPrimary.withOpacity(0.0),
...
backButtonWithActionAndIcon(IconData icon,BuildContext context, VoidCallback? action){
  return ElevatedButton(
      onPressed: action,
      style: ElevatedButton.styleFrom(
          elevation: 3,
...
return ElevatedButton(onPressed: callback,
      style: ElevatedButton.styleFrom(
      elevation: 3, backgroundColor: colorMilkWhite,
      padding: padding,
...
inputCodeVerifier(TextEditingController controller,int pinLength, bool showInput,ValueChanged<String> onChange, Function(String)? onComplete, StreamController<ErrorAnimationType>? errorController,BuildContext context){
...
searchFieldMain(FormFieldValidator<String> validator, bool enabled, TextEditingController controller, VoidCallback? onClear) {
  return TextFormField(
    enabled: enabled,
    validator: validator,
    controller: controller,
    ...
    decoration: InputDecoration(
      ...
      suffixIcon:  Padding(padding: const EdgeInsets.only(left: 0, right: 8,),
        child: IconButton(onPressed: onClear, icon:  Icon(
      ...
      child: Align(alignment: Alignment.topLeft,
        child: Row(
          ...
          children: [
            ...
            Padding(padding: const EdgeInsets.only(left: 6, right: 16),
...
/*
newsLetterCard(NewsLetter news, VoidCallback? onPressed){

  var tagsList = (news.tags ?? []).map((e) => Padding(padding: const EdgeInsets.only(right: 16, top: 8),
    child: Row(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.center,
      mainAxisAlignment: MainAxisAlignment.start,
      children:[
        ...
        textWithColor(e, 10, TextType.Bold, colorPrimaryLight)
      ] ,
    ),)).toList();
...
Widget pieChartIndicator( {required Color color,required String text,required bool isSquare,required double size,required Color textColor}){
  return Row(
    mainAxisAlignment: MainAxisAlignment.start,
    crossAxisAlignment: CrossAxisAlignment.center,
    mainAxisSize: MainAxisSize.min,
